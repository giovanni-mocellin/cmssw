...
if options.runNum == -1:
	options.runNum = runConfig.RunNumber
	print 'runNumber defined by input file = {0}'.format(options.runNum)
...
process.GEMGlobalTrackingGeometryESProducer = cms.ESProducer("GEMGlobalTrackingGeometryESProducer")
process.myPrefer2 = cms.ESPrefer('GEMGlobalTrackingGeometryESProducer')
